...
These are **emergency fallbacks**, not Pocket AI's normal starting tier. Normal model selection begins with Qwen3 0.6B after the installer downloads a safe regular tier.
