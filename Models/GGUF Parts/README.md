# Pocket AI Project Emergency GGUF Parts

The two bundled SmolLM2 135M models are stored as ordered binary parts so every packaged model file remains below 60 MB.

These are **emergency fallbacks**, not Pocket AI Project's normal starting tier. Normal model selection begins with Qwen3 0.6B after the installer downloads a safe regular tier.
